...
# main config
PLUGINSLUG="wp-force-https"
CURRENTDIR=`pwd`
MAINFILE="wordpress-force-https.php" # this should be the name of your main php file in the wordpress plugin
...
SVNURL="http://plugins.svn.wordpress.org/wp-force-https/" # Remote SVN repo on wordpress.org, with no trailing slash
